...
void aircraft(){
	...
	glColor3f(0.282, 0.239, 0.545); //Move to the center of the trapezoid
	...
	glPushMatrix(); //Save the current state of transformations
	glTranslatef(-1.0, 2.8, 0.0); //Move to the center of the pentagon
	...
	//Triangle
	glVertex3f(4.59, -1.5, 0.0);
    glVertex3f(5.2, -0.9, 0.0);
	...
	//Trapezoid
	glVertex3f(5.3, 0.4, 0.0);
	glVertex3f(4.3, -.52, 0.0);
	glVertex3f(4.7, -0.52, 0.0);
	glVertex3f(5.3, .1, 0.0);
